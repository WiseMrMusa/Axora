    ...
    return (
        <div className=" w-5/6 sm:w-96 p-3 mt-10 rounded-lg ring-1 ring-slate-300 bg-white">
            <Tabs defaultValue="stake">
                <TabsList>
                    <TabsTrigger value="stake" className="p-2">Stake</TabsTrigger>
                    <TabsTrigger value="unstake" className="p-2">Unstake</TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="unstake">
                    <div className="flex flex-col gap-2 w-full mt-4">
                        ...
                        <div className="relative m-auto" >
                            <div className="fixed z-30 ring-2 ring-white bg-slate-300 rounded-xl p-1 -m-4">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 12c0-1.232-.046-2.453-.138-3.662a4.006 4.006 0 00-3.7-3.7 48.678 48.678 0 00-7.324 0 4.006 4.006 0 00-3.7 3.7c-.017.22-.032.441-.046.662M19.5 12l3-3m-3 3l-3-3m-12 3c0 1.232.046 2.453.138 3.662a4.006 4.006 0 003.7 3.7 48.656 48.656 0 007.324 0 4.006 4.006 0 003.7-3.7c.017-.22.032-.441.046-.662M4.5 12l3 3m-3-3l-3 3" />
                                </svg>
